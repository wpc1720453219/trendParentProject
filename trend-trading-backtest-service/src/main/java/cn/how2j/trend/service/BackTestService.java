...
//      }
    ...
    public float getYear(List<IndexData> allIndexDatas){
        ...
        String sDataStart = allIndexDatas.get(0).getDate();
        String sDataEnd = allIndexDatas.get(allIndexDatas.size() - 1).getDate();

        Date dateStart = DateUtil.parse(sDataStart);
        Date dateEnd = DateUtil.parse(sDataEnd);
